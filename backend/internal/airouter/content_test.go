...
func TestValidateContentRejects(t *testing.T) {
	...
	cases := map[string]Task{
		...
		"too few words": {Type: "vocabulary", Content: func() json.RawMessage {
		...
		"blank definition": {Type: "vocabulary", Content: func() json.RawMessage {
			var c VocabularyContent
			_ = json.Unmarshal(SampleContent("vocabulary"), &c)
		...
		"short passage": {Type: "reading", Content: func() json.RawMessage {
		...
		"article-length passage": {Type: "reading", Content: func() json.RawMessage {
			var c ReadingContent
			_ = json.Unmarshal(SampleContent("reading"), &c)
		...
		"three practice questions": {Type: "practice", Content: func() json.RawMessage {
