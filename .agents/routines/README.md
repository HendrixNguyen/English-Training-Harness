...
| 22:00 | 15:00 | [daily-ship](daily-ship.md) | `production` fast-forwarded to `origin/main` when its CI is green; one `Deploy` run (PWA + smoke checks) reported. No PR. |
