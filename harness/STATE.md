...
_Generated 2026-09-23 17:14. Do not edit — run `python3 tools/harness/cli.py state`._
...
- `harness/ideas/_inbox/ci-never-runs-gofmt-so-three-files-on-main-are-unformatted-a.md` — CI never runs gofmt so three files on main are unformatted and nothing fails [medium]
