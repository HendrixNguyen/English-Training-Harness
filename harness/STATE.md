...
_Generated 2026-09-24 23:04. Do not edit — run `python3 tools/harness/cli.py state`._
...
- `harness/plans/2026-09-24-cmd-api-drain-test-passes-with-srv-shutdown-deleted-so-the-s.md` — cmd/api amend: make the drain test observe the drain — it must fail when `srv.Shutdown` is gone — Plan [high] (review: pass)
